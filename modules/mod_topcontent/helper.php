...
class modTopContentHelper
{
    ...
    public static function gettopview()
    {
        ...
        $query          = "SELECT jv_content.id AS article_id, jv_content.alias as article_alias,
                            jv_content.asset_id AS article_assetid,jv_content.title as title,
                            jv_content.hits as hits, jv_content.language as language, jv_content.catid as cat_id FROM jv_content WHERE state=1 ORDER BY hits DESC LIMIT 25";     
        $db->setQuery($query);
    ...
    public static function getRecentTop()
    {
        ...
        $query          = "SELECT jv_content.id AS article_id, jv_content.alias as article_alias, jv_content.created as article_create,
                            ...
                            jv_content.hits, jv_content.language as language, jv_categories.alias AS cat_alias, jv_content.catid as cat_id, jv_categories.title as cat_title FROM jv_content INNER JOIN jv_categories
