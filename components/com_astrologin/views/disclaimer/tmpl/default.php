...
<div class="lead alert alert-dark">Acceptance of our Terms</div>
...
to astroisha.com, you agree to be bound by the following <a href="<?php echo JURI::base() ?>terms">Terms and Conditions</a> of Service.
 If you do not want to be bound by our Terms your only option is not to visit, view or otherwise
...
<div class="lead alert alert-dark">Provision of Services</div>
...
<div class="lead alert alert-dark">Proprietary Rights</div>
...
and international intellectual property treaties. astroisha.com authorizes you to 
...
<div class="lead alert alert-dark">Submitted Content</div>
...
<div class="lead alert alert-dark">Termination of Agreement</div>
...
<div class="lead alert alert-dark">Disclaimer of Warranties</div>
...
as to the operation of the astroisha.com website, information, content, materials, 
or products. This shall include, but not be limited to, implied warranties of 
...
<div class="lead alert alert-dark">Limitation of Liability</div>
...
limited to damages for loss of profits, business interruption, business reputation or goodwill, 
loss of programs or information or other intangible loss arising out of the use of or the inability 
to use the service, or information, or any permanent or temporary cessation of such service or 
access to information, or the deletion or corruption of any content or information, or the failure 
to store any content or information. The above limitation shall apply whether or not astroisha.com 
has been advised of or should have been aware of the possibility of such damages. 
...
<div class="lead alert alert-dark">External Content</div>
<div>
...
<div class="lead alert alert-dark">Jurisdiction</div>
...
to resolve any legal matter arising from this agreement or related to your use 
...
<div class="lead alert alert-dark">Entire Agreement</div>
...
<div class="lead alert alert-dark">Changes to the Terms</div>
