...
$text 			= array("Education","Career","Marriage","Health","Finance","Children");
//print_r($this->order);
...
<div><a href="<?php echo Juri::base().'readyogas?order='.$order.'&ref='.$refemail; ?>"><i class="bi bi-arrow-left-circle-fill"></i> Prev</a></div>
<div><a href="<?php echo Juri::base().'read-report?order='.$order.'&ref='.$refemail; ?>"><i class="bi bi-house-door-fill"></i> Report Home</a></div>
<div><a href="<?php echo Juri::base().'readsadesati?order='.$order.'&ref='.$refemail; ?>">Next <i class="bi bi-arrow-right-circle-fill"></i></a></div>
</div>
<div class="mb-4"></div>
<?php
