...
<div class="col-4 text-left"><a href="<?php echo Juri::base().'readdasha?order='.$order.'&ref='.$refemail; ?>"><i class="fas fa-arrow-left"></i> Previous</a></div>
...
<div class="col-4 text-right"><a href="<?php echo Juri::base().'readforecast?order='.$order.'&ref='.$refemail; ?>"><i class="fas fa-arrow-right"></i> Next</a></div>
</div></div>
<div class="mb-4"></div>
<?php
