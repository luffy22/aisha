...
$text 		= array("First House","Second House", "Third House","Fourth House","Fifth House","Sixth House","Seventh House",
					"Eight House","Ninth House","Tenth House","Eleventh House","Twelfth House");
//print_r($this->order);
...
<div><a href="<?php echo Juri::base().'readplanet?order='.$order.'&ref='.$refemail; ?>"><i class="bi bi-arrow-left-circle-fill"></i> Prev</a></div>
<div><a href="<?php echo Juri::base().'read-report?order='.$order.'&ref='.$refemail; ?>"><i class="bi bi-house-door-fill"></i> Report Home</a></div>
<div><a href="<?php echo Juri::base().'readdasha?order='.$order.'&ref='.$refemail; ?>">Next <i class="bi bi-arrow-right-circle-fill"></i></a></div>
</div>
<div class="mb-4"></div>
<?php
