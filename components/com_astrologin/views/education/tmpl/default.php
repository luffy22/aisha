...
<div class='card-body'>
	<strong>Order Processing Time</strong>- Minimum 7-10 working days(Monday-Friday). You will be notified via email if 
	there is more delay likely. Max 30 days after which full refund provided.
</div></div>
<ul class="list-group">
  <li class="list-group-item list-group-item-dark"><strong>Education Report Contents</strong></li>
  <li class="list-group-item">Fourth House in Main Chart(D-1 Chart). Deals with basic education. Analysis with diagram of placements and aspects</li>
  <li class="list-group-item">Fifth House in Main Chart(D-1 Chart). Deals with knowledge.<li>
  <li class="list-group-item">Ninth House in Main Chart(D-1 Chart). Deals with higher and foreign education. Analysis with diagram of placements and aspects</li>
  <li class="list-group-item">Twelfth House in Main Chart(D-1 Chart). Deals with Phd. and Research. Also deals with settling abroad.</li>
  <li class="list-group-item">Third House in Main Chart(D-1 Chart). Deals with creative writing for those writing thesis and academic report.</li>
  <li class="list-group-item">Sixth House in Main Chart(D-1 Chart). Deals with enemies. For those giving competitive exams.</li>
  <li class="list-group-item">Short and simple analysis of Chaturvimsamsa Chart(D-20 Chart) which deals with education, learning and knowledge.</li>
...
<div class="mb-3"></div>
<input type="hidden" name="select_report" id="select_report" value ="education" />
