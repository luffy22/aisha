...
{
    //alert("calls");
    var c=document.getElementById("moon_canvas");
...
{
    var moon_sign   = document.getElementById("Moon_sign").getAttribute('value');
...
function house_8_canvas(y)
{
    ...
    if(len == "1")
    {
        ctx.fillText(y[0],105,155);
    }
    else if(len == "2")
    {
        ctx.fillText(y[0],105,140);
        ctx.fillText(y[1],105,145);
    }
}
