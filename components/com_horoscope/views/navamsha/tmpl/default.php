...
{
    //alert("calls");
    var c=document.getElementById("navamsha_canvas");
...
{
    var x = document.getElementById("Ascendant").getAttribute('value');
...
{
    var moon_sign   = document.getElementById("Ascendant").getAttribute('value');
    ...
    {
       if(moon_sign == document.getElementById(planets[i]).getAttribute('value'))
       {
            x       = planets[i];
            y.push(x);        
       }
...
function house_2_planets(z)
{
    ...
    for(var i=0;i<planets.length; i++)
    {
       if(sign_2 == document.getElementById(planets[i]).getAttribute('value'))
       {
            x       = planets[i];
            y.push(x);           
       }
...
function house_3_planets(z)
{
    ...
    for(var i=0;i<planets.length; i++)
    {
       if(sign_3 == document.getElementById(planets[i]).getAttribute('value'))
       {
            x       = planets[i];
            y.push(x);
       }
...
function house_4_planets(z)
{
    ...
    for(var i=0;i<planets.length; i++)
    {
       if(sign_4 == document.getElementById(planets[i]).getAttribute('value'))
       {
            x       = planets[i];
            y.push(x);
       }
...
function house_5_planets(z)
{
    ...
    for(var i=0;i<planets.length; i++)
    {
       if(sign_5 == document.getElementById(planets[i]).getAttribute('value'))
       {
            x       = planets[i];
            y.push(x);
       }
...
function house_6_planets(z)
{
    ...
    for(var i=0;i<planets.length; i++)
    {
       if(sign_6 == document.getElementById(planets[i]).getAttribute('value'))
       {
            x       = planets[i];
            y.push(x);
       }
...
function house_7_planets(z)
{
    ...
    for(var i=0;i<planets.length; i++)
    {
       if(sign_7 == document.getElementById(planets[i]).getAttribute('value'))
       {
            x       = planets[i];
            y.push(x);
       }
...
function house_8_planets(z)
{
    ...
    for(var i=0;i<planets.length; i++)
    {
       if(sign_8 == document.getElementById(planets[i]).getAttribute('value'))
       {
            x       = planets[i];
            y.push(x);
       }
...
function house_9_planets(z)
{
    ...
    for(var i=0;i<planets.length; i++)
    {
       if(sign_9 == document.getElementById(planets[i]).getAttribute('value'))
       {
            x       = planets[i];
            y.push(x);
       }
...
function house_10_planets(z)
{
    ...
    for(var i=0;i<planets.length; i++)
    {
       if(sign_10 == document.getElementById(planets[i]).getAttribute('value'))
       {
            x       = planets[i];
            y.push(x);
       }
...
function house_11_planets(z)
{
    ...
    for(var i=0;i<planets.length; i++)
    {
       if(sign_11 == document.getElementById(planets[i]).getAttribute('value'))
       {
            x       = planets[i];
            y.push(x);
       }
...
function house_12_planets(z)
{
    ...
    for(var i=0;i<planets.length; i++)
    {
       if(sign_12 == document.getElementById(planets[i]).getAttribute('value'))
       {
            x       = planets[i];
            y.push(x);
       }
...
function house_11_canvas(y)
{
    ...
    ctx.font='38% verdana';
    ctx.fillText(y[0],130,32);
    ctx.fillText(y[1],130,40);
    ctx.fillText(y[2],130,48);
}
...
?>
        ...
        <td id="<?php echo $new_key1 ?>" value="<?php echo $new_val2; ?>"><?php echo $new_val2; ?></td>
<?php 
