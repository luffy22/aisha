...
<form role="form" enctype="application/x-www-form-urlencoded" method="post" 
    ...
    ?>    
        <input type="date" name="career_dob" class="form-control" placeholder="25/03/1984" />
    <?php
        }
        else
        {
    ?>
        <input type="date" id="datepicker" name="career_dob" class="form-control" placeholder="25/03/1984" />
    <?php
        }
    ?>
    </div>
