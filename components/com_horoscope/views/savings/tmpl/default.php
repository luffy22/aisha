...
<form role="form" enctype="application/x-www-form-urlencoded" method="post" 
    ...
    <div class="form-group">
        ...
        <input type="text" id="savings_lat_1" class="form-text1" name="lat_deg" placeholder="deg"  />
        <input type="text" id="savings_lat_2" class="form-text1" name="lat_min" placeholder="min" />
    ...
    <div class="form-group">
        ...
        <input type="text" id="savings_long_1" class="form-text1" name="lon_deg" placeholder="deg"  />
        <input type="text" id="savings_long_2" class="form-text1" name="lon_min" placeholder="min" />
