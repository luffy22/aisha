...
{   
    ...
    if(a == "1")
    {
        get_canvas(); ctx1.beginPath(); ctx1.font='8px Arial'; ctx1.fillText(x,y,z);
    }
    else if(a == "2")
    {
        get_canvas(); ctx2.beginPath(); ctx2.font='8px Arial'; ctx2.fillText(x,y,z);
    }
    else if(a == "3")
    {
        get_canvas(); ctx3.beginPath(); ctx3.font='8px Arial'; ctx3.fillText(x,y,z);
    }
    else if(a == "4")
    {
        get_canvas(); ctx4.beginPath(); ctx4.font='8px Arial'; ctx4.fillText(x,y,z);
    }
    else if(a == "5")
    {
        get_canvas(); ctx5.beginPath(); ctx5.font='8px Arial'; ctx5.fillText(x,y,z);
    }
    else if(a == "6")
    {
        get_canvas(); ctx6.beginPath(); ctx6.font='8px Arial'; ctx6.fillText(x,y,z);
    }
    else   if(a == "7")
    {
        get_canvas(); ctx7.beginPath(); ctx7.font='8px Arial'; ctx7.fillText(x,y,z);
    }
    else if(a == "8")
    {
        get_canvas(); ctx8.beginPath(); ctx8.font='8px Arial'; ctx8.fillText(x,y,z);
    }
    else if(a == "9")
    {
        get_canvas(); ctx9.beginPath(); ctx9.font='8px Arial'; ctx9.fillText(x,y,z);
    }
    else if(a == "10")
    {
        get_canvas(); ctx10.beginPath(); ctx10.font='8px Arial'; ctx10.fillText(x,y,z);
    }
    else if(a == "11")
    {
        get_canvas(); ctx11.beginPath(); ctx11.font='8px Arial'; ctx11.fillText(x,y,z);
    }
    else if(a == "12")
    {
        get_canvas(); ctx12.beginPath(); ctx12.font='8px Arial'; ctx12.fillText(x,y,z);
    }
    else if(a == "13")
    {
        get_canvas(); ctx13.beginPath(); ctx13.font='8px Arial'; ctx13.fillText(x,y,z);
    }
    else if(a == "14")
    {
        get_canvas(); ctx14.beginPath(); ctx14.font='8px Arial'; ctx14.fillText(x,y,z);
    }
    else if(a == "15")
    {
        get_canvas(); ctx15.beginPath(); ctx15.font='8px Arial'; ctx15.fillText(x,y,z);
    }
    else if(a == "16")
    {
        get_canvas(); ctx16.beginPath(); ctx16.font='8px Arial'; ctx16.fillText(x,y,z);
    }
}
...
function house_1_planets(a)
{
   var charts      = ["_lagna","_navamsha_sign","_dash","_hora","_drekan","_chatur",
                        ...
                        "_trim","_khed","_aksh","_shast"];
                    
    var planets     = ["ascendant","sun","moon","mars","mercury","jupiter","venus","saturn","rahu","ketu","uranus","neptune","pluto"];
    ...
    for(var k=0;k<charts.length;k++)
   {
        for(var i=0;i<planets.length; i++)
        {
           ...
           x        = planets[i]+charts[k];
           val      = document.getElementById(x).getAttribute('value');
           y.push(val);
        }
        if(y.length > 0)        // check if there are any planets in house
        {
            house_cent_canvas(a, 1, y,117,66);      // execute only if there are planets
        }
...
function house_planets(a,b, z)
{
    var num         = b;
    var y           = get_planets(a, num, z);
    if(y== "0"){}else
    {
        if(num == "2")
        {
            house_up_canvas(a,num,y,55,35);
        }
        else if(num == "3")
        {
            house_cent_canvas(a,num,y,7,60);
        }
        else if(num == "4")
        {
            house_cent_canvas(a,num,y,55,130);
        }
        else if(num == "5")
        {
            house_cent_canvas(a, num,y,7,190);
        }
        else if(num == "6")
        {
            house_down_canvas(a, num,y,55,230);
        }
        else if(num == "7")
        {
            house_cent_canvas(a,num,y,117,180);
        }
        else if(num == "8")
        {
            house_down_canvas(a,num,y,180,230);
        }
        else if(num == "9")
        {
            house_right_canvas(a,num,y,215,190);
        }
        else if(num == "10")
        {
            house_cent_canvas(a,num,y,180,130);
        }
        else if(num == "11")
        {
            house_right_canvas(a,num,y, 215,70);
        }
        else if(num == "12")
        {
            house_up_canvas(a,num,y,180,35);
        }
