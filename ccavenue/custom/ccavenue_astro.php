...
?>
	<form method="POST" name="customerData" action="ccavRequestHandler.php">
		...
		<input type="hidden" name="merchant_id" value="79450"/></td>
		<input type="hidden" name="amount" value="<?php echo trim($fees); ?>"/>
		<input type="hidden" name="currency" value="<?php echo $currency; ?>" />
		<input type="hidden" name="redirect_url" value="<?php echo $server.'/ccavenue/custom/ccavResponseHandler.php' ?>"/>
        <input type="hidden" name="cancel_url" value="<?php echo $server.'/ccavenue/custom/ccavResponseHandler.php?payment=fail' ?>"/>
		<input type="hidden" name="language" value="EN"/>
		<table class="table table-striped">
		 <tr>
		     <td colspan="2">Payment information:</td>
		 </tr>
		 <tr><td>Order ID: </td><td><input type="text " name="order_id" value="<?php echo trim($token1); ?>" disabled /></td></tr>
