...
?>
    <form method="post" id="customerData" name="customerData" action="ccavTestHandler.php">
        ...
        <input type="text" name="redirect_url" value="<?php echo $server.'/ccavenue/nonseam/ccavResponseHandler3.php' ?>"/>
        <input type="text" name="cancel_url" value="<?php echo $server.'/ccavenue/nonseam/ccavResponseHandler3.php?payment=fail'; ?>"/>
