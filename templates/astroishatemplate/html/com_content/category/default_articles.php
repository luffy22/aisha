		...
		<?php if ($this->params->get('filter_field') !== 'hide') : ?>
			<div class="form-group">
				...
				<?php else : ?>
					...
					<input type="text" name="filter-search" id="filter-search" value="<?php echo $this->escape($this->state->get('list.filter')); ?>" class="form-control form-control-lg" onchange="document.adminForm.submit();" title="<?php echo JText::_('COM_CONTENT_FILTER_SEARCH_DESC'); ?>" placeholder="<?php echo JText::_('COM_CONTENT_' . $this->params->get('filter_field') . '_FILTER_LABEL'); ?>" />
				<?php endif; ?>
			</div>
		<?php endif; ?>
			...
			<tr>
				...
				<?php if ($this->params->get('list_show_hits')) : ?>
					<th scope="col" id="categorylist_header_hits">
						<?php echo JHtml::_('grid.sort', 'Views', 'a.hits', $listDirn, $listOrder); ?>
					</th>
				<?php endif; ?>
