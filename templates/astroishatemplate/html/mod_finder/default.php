...
<form id="mod-finder-searchform<?php echo $module->id; ?>" action="<?php echo JRoute::_($route); ?>" method="get">
	<div class="input-group input-group-lg">
		<label for="mod-finder-searchword114" class="element-invisible finder">Search</label>
                <input type="text" name="q" id="mod-finder-searchword114" class="form-control" size="30" value="" placeholder="Search...">
                <div class="input-group-prepend">
                <button class="btn btn-primary disabled" type="submit" title="Go"><span class="icon-search icon-white"></span></button>
                </div>
