...
");
?>
<script src="<?php echo JURI::base() ?>administrator/templates/isis/css/template.css"></script>
<div class="mt-2"></div>
        ...
        <div class="btn-toolbar">
            <div class="btn-group">
                    <button type="button" class="btn btn-success" onclick="Joomla.submitbutton('article.save')">
                            <i class="fa fa-check" aria-hidden="true"></i> <?php echo JText::_('JSAVE') ?>
                    </button>
            </div>
            <div class="btn-group">
                    <button type="button" class="btn btn-danger" onclick="Joomla.submitbutton('article.cancel')">
                            <si class="fa fa-times" aria-hidden="true"></i> <?php echo JText::_('JCANCEL') ?>
                    </button>
            </div>
