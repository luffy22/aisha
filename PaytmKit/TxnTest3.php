...
<body>
	...
	<form method="post" action="pgRedirect3.php" name="txntest3">
		<table border="1">
			<tbody>
				<tr>
					<th>S.No</th>
				...
				<tr>
					...
					<td><input title="TXN_AMOUNT" tabindex="10"
						...
						value="<?php echo trim($price); ?>">
                                ...
                                <input type="hidden" name="CALLBACK_URL" value="https://www.astroisha.com/PaytmKit/pgResponse3.php" />
				<tr>
					<td></td>
					<td></td>
